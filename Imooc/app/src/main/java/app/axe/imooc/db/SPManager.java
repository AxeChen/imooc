...
import app.axe.imooc.application.ImoocApplication;
...
public class SPManager {
    ...
    private SPManager() {
        sp = ImoocApplication.getInstance().getSharedPreferences(SHARE_PREFREENCE_NAME, Context.MODE_PRIVATE);
        editor = sp.edit();
    }
